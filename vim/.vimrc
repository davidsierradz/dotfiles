...
hi SpecialKey cterm=standout ctermfg=3 ctermbg=NONE guifg=#657b83 guibg=NONE
hi VertSplit cterm=reverse guifg=#FF8700 guibg=#FF8700
"hi SpecialKey ctermfg=0
    " Text width ruler
    set colorcolumn=81
    highlight ColorColumn ctermbg=magenta guibg=#d33682
